...
export default function Checkout() {
  ...
  const buildWhatsAppMessage = (orderId: number): string => {
    const itemLines = items
      .map(
        (i) =>
          `- ${i.quantity}x ${i.product.name} ${i.product.volume_ml}ml (${formatCOP(i.product.price * i.quantity)})`,
      )
      .join("\n");
    ...
    <div className="max-w-6xl mx-auto px-6 py-16">
      ...
      >
        ...
        <div className="lg:col-span-3 space-y-10">
          {/* Contact Info */}
          <section>
            <h2 className="text-lg font-medium text-[#d4af37] mb-6 tracking-widest uppercase">
              Datos de Contacto
            </h2>
            ...
            <div className="space-y-3">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-white font-medium">
                      Pago Electrónico con PSE
                    </span>
                  </div>
                  <p className="text-gray-400 text-sm font-light">
                    Pago seguro en línea mediante débito bancario. Todas las
                    transacciones están encriptadas y son 100% seguras.
                  </p>
                  <div className="flex gap-3 mt-3">
                    {["Bancolombia", "Davivienda", "Nequi", "Wompi"].map(
                      (bank) => (
                        <span
                          key={bank}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-400 text-sm font-light">
                    Paga en efectivo o transferencia bancaria en el momento de
                    recibir tu pedido. El paquete será verificado antes de
                    pagar.
                  </p>
                </div>
              </label>
          ...
          {error && (
            <p className="text-red-400 text-sm bg-red-500/10 border border-red-500/30 px-4 py-3 rounded-lg">
              {error}
            </p>
          )}
        </div>
